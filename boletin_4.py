...
if edad<100 and (0<edad<12):
    print("Niño")

elif edad<100 and(13<edad<17):
    print("Adolescente")
    
elif edad<100 and(18<edad<29):
    print("Joven")
...
horario1=(hora_1*60)+(min_1*60)+seg_1 
horario2=(hora_2*60)+(min_2*60)+seg_2 
...
horario1 = (hora_1 + min_1 + seg_1)
horario2 = (hora_2 + min_2 + seg_2)


if horario1>horario1  :
